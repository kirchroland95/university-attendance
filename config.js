...
const COURSES = {
  ...
  2: {
    ...
    name: "BAZE DE DATE",
    shortName: "DB",
    scriptUrl: "https://script.google.com/macros/s/AKfycbwY2hMj-8XGutHr2xBkrFFDUZXF6cSda5x8XOlO_Zl97JjmRmRC18TmjI6gXDyV9wR1/exec"
  },
  3: {
    id: 3,
  ...
  4: {
    id: 4,
    name: "ECUAȚII DIFERENȚIALE",
    shortName: "ED",
    scriptUrl: "https://script.google.com/macros/s/AKfycbyCod1NfmTEgXIrqmhBUeEg6OD3LLAzEvgZSlLHBPhI3SvpDJw8y1-uZwcH30laMMkH/exec"
  },
  5: {
    id: 5,
